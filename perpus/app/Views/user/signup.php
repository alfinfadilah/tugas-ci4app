...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="asset/AdminLTE-3.2.0/AdminLTE-3.2.0/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="asset/AdminLTE-3.2.0/AdminLTE-3.2.0/index2.html" class="h1"><b>Register</b></a>
    </div>
    <div class="card-body">
      ...
      <form action="/register/simpan" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="NamaLengkap" placeholder="Nama Lengkap" value="<?= set_value('NamaLengkap') ?>">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-user  "></span>
            </div>
...
<!-- Bootstrap 4 -->
<script src="asset/AdminLTE-3.2.0/AdminLTE-3.2.0/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
<script src="asset/AdminLTE-3.2.0/AdminLTE-3.2.0/dist/js/adminlte.min.js"></script>
</body>
</html>
